## The functions described here calculate the inverse of a matrix and 
# saves it to the cache such that next time the user attempts
# to calculate the matrix inverse, the previously saved value is returned
# instead of repeating the calculation.

## The function below creates a special 'matrix' ojbect, which is really 
